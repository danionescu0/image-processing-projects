...
class FacePaths:
    ...
    def __init__(self, images_folder: str, thumbs_folder: str) -> None:
        self.__images_folder = images_folder
        self.__thumbs_folder = thumbs_folder
    ...
    def get_low_resolution(self, face_id: str, file_extension: str) -> str:
        return os.path.join(self.__thumbs_folder, face_id + '.' + file_extension)